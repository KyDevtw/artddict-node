...
// 引入 map SQL 語法
const NewsComm = require("../domain/news.js");
...
router.get("/", (req, res, next) => {
  ...
  if (!Object.keys(req.query).length) executeSQL(NewsComm.getAllNewsSQL(), res);

  else executeSQL(NewsComm.getNewByQuerySQL(req.query), res);
...
router.post('/', (req, res, next) => {
    ...
    //!!值為一個一個傳進去 因此數量跟順序都要對應 Class的constructor順序
    ...
    console.log(123)
    executeSQL(newsComm.addNewsComToSever(), res, 'post', false, newsComm)
  })
